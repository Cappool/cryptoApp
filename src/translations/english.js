const en = {
  translation: {
    ...
    about: {
      ...
      a5: "A total of 15% of the token supply has been allocated for burning. Upon the addition of liquidity pools, an immediate burn of 10% of the supply will take place. Additionally, 5% of the supply has been allocated for buybacks and subsequent burning. These strategies aim to diminish the token's supply over time, increasing scarcity.",
    },
    tokenomics: {
      title: "TOKENOMICS",
    ...
    roadmap: {
      ...
      r6: "Launch $DEDPOOL token on renowned DEXs, ensuring abundant liquidity and seamless trading. Immediately upon the addition of liquidity pools, the LP tokens will be burnt. Trade with ease! A total of 15% of the token supply has been allocated for burning. Upon the addition of liquidity pools, an immediate burn of 10% of the supply will take place. Additionally, 5% of the supply has been allocated for buybacks and subsequent burning. These strategies aim to diminish the token's supply over time, increasing scarcity.     ",
    ...
    faq: {
      ...
      a3: "DedPool's primary utility lies in the ability to acquire the token at an exceptionally low cost and subsequently stake it for earning passive rewards. Immediately upon the addition of liquidity pools, the LP tokens will be burnt. A total of 15% of the token supply has been allocated for burning. Upon the addition of liquidity pools, an immediate burn of 10% of the supply will take place. Additionally, 5% of the supply has been allocated for buybacks and subsequent burning.",
    ...
    errors: {
      ...
      // "Insufficient BNB for transaction! Make sure you have enough BNB for gas and token exchange.",
